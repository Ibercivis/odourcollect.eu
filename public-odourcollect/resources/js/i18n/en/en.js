export default {
  ...
  ABOUT: {
    ...
    "<p>OdourCollect is an idea of Science for Change. This app has been developed thanks to the D-NOSES Project (Distributed Network for Odour Sensing, Empowerment and Sustainability). We are validating our bottom-up methodology in 10 pilots projects in 10 countries (Spain, Portugal, Greece, Bulgaria, Chile, Italy, UK, Germany, Austria and Uganda).</p><p>This project has received funding from the European Union’s Horizon 2020 Research and Innovation Programme under Grant Agreement No 789315. This project has also received funding from FECYT.</p><p>OdourCollect is part of the Barcelona Citizen Science Office.</p> " + 
	"<p>OdourCollect has received funding from the European Union Horizon 2020 Research and Innovation program under agreement No. 789315. This project also has the collaboration of the Spanish Foundation for Science and Technology - Ministry of Science and Innovation.</p>" + 
