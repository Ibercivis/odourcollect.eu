    ...
    export default {
        ...
        data() {
            return {
                ...
                annoy_info: [this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.EXTREMELY_UNPLEASANT.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.MODERATE_UNPLEASANT.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.UNPLEASANT.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.SLIGHTLY_UNPLEASANT.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.NEUTRAL.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.SLIGHTLY_PLEASANT.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.PLEASANT.DEFINITION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.MODERATE_PLEASANT.DEFINITION'),this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.EXTREMELY_PLEASANT.DEFINITION')],
                annoy_description: [this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.EXTREMELY_UNPLEASANT.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.MODERATE_UNPLEASANT.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.UNPLEASANT.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.SLIGHTLY_UNPLEASANT.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.NEUTRAL.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.SLIGHTLY_PLEASANT.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.PLEASANT.DESCRIPTION'), this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.MODERATE_PLEASANT.DESCRIPTION'),this.$t('ODOUR.CLASSIFICATION_BY_ANNOYANCE.EXTREMELY_PLEASANT.DESCRIPTION')],
                state : {
                    status : false,
                    msg: '',
                    title: ''
